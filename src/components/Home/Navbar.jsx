...
import { categoryCat } from '../../actions/actions'
                        ...
                        <ul className="dropdown-menu min-w-max absolute bg-white text-base z-50 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 m-0 ml-2 bg-clip-padding border-none" aria-labelledby="dropdownButton">
                            {
                                categories.map(category => (
                                    <li key={category.id}>
                                        <a href="#" className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white" onClick={() => dispatch(categoryCat(`${category.id}`))}>{category.name}</a>
                                    </li>
                                ))
                            }
                        </ul>
